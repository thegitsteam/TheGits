...
test.describe('Test Create Incidents', function() {
	...
	function createIncident(path) {
		...
		driver.findElement({xpath: '//*[@id="typeOfBuilding"]/option['+(Math.floor(Math.random() * 11) + 3)+']'}).click();
		...
		driver.findElement({xpath: '//*[@id="suspectStatus"]/option['+(Math.floor(Math.random() * 6) + 3)+']'}).click();
